...
class TestKeyMetrics {
    ...
    public static void makeConnection(){
        model = new Model();
        paths = new String[3];
        String path1 = new File("").getAbsolutePath().concat("/2_week_campaign_2/click_log.csv");
        paths[1]= path1;
        System.out.println(paths[1]);
        String path0 = new File("").getAbsolutePath().concat("/2_week_campaign_2/impression_log.csv");
        paths[0]= path0;
        String path2 = new File("").getAbsolutePath().concat("/2_week_campaign_2/server_log.csv");
        File file = new File("/home/metodi/SEG/SEG/2_week_campaign_2/impression_log.csv");
